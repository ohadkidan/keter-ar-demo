import { MainImageCarousel } from "@/sections/ProductPage/components/MainImageCarousel";
import { ThumbnailCarousel } from "@/sections/ProductPage/components/ThumbnailCarousel";

export const ProductMediaGallery = () => {
  return (
    <div className="text-sm box-border caret-transparent basis-full shrink-0 leading-[25.375px] max-w-full min-h-[auto] min-w-[auto] order-1 outline-[3px] px-[5px] md:text-[15.6667px] md:basis-[58.3333%] md:leading-[28.3958px] md:max-w-[58.3333%] md:px-2.5">
      <div className="relative text-sm box-border caret-transparent leading-[25.375px] outline-[3px] md:text-[15.6667px] md:leading-[28.3958px]">
        <MainImageCarousel />
        <div className="text-sm box-border caret-transparent hidden leading-[25.375px] outline-[3px] md:text-[15.6667px] md:block md:leading-[28.3958px]">
          <ThumbnailCarousel />
        </div>
        <div className="text-sm box-border caret-transparent block leading-[25.375px] outline-[3px] md:text-[15.6667px] md:hidden md:leading-[28.3958px]">
          <div className="absolute text-sm items-end box-border caret-transparent flex flex-wrap leading-[25.375px] outline-[3px] mb-4 left-0 top-4 md:static md:text-[15.6667px] md:leading-[28.3958px] md:left-auto md:top-auto">
            <span className="text-emerald-900 text-xs font-semibold bg-gray-100 box-border caret-transparent block tracking-[-0.24px] leading-3 min-h-[auto] min-w-[auto] outline-[3px] text-center border-emerald-900 mr-2 mb-1 px-3 py-0.5 rounded-2xl border-2 border-solid md:bg-transparent md:min-h-0 md:min-w-0">
              Stackable Design
            </span>
          </div>
        </div>
        ...
        <div className="text-sm box-border caret-transparent leading-[25.375px] outline-[3px] md:text-[15.6667px] md:leading-[28.3958px]">
          <div className="text-sm box-border caret-transparent flex flex-wrap leading-[25.375px] ml-[-5px] mr-[-5px] outline-[3px] w-[calc(100%_+_10px)] md:text-[15.6667px] md:leading-[28.3958px] md:w-[calc(100%_+_20px)] md:-mx-2.5">
            <div className="text-sm box-border caret-transparent basis-full shrink-0 leading-[25.375px] max-w-full min-h-0 min-w-0 outline-[3px] px-[5px] md:text-[15.6667px] md:leading-[28.3958px] md:min-h-[auto] md:min-w-[auto] md:px-2.5">
              <div className="relative text-sm box-border caret-transparent leading-[25.375px] outline-[3px] mb-5 md:text-[15.6667px] md:leading-[28.3958px]">
                    ...
                    <div className="text-sm box-border caret-transparent leading-[25.375px] outline-[3px] pb-6 md:text-[15.6667px] md:leading-[28.3958px]">
                      ...
                      >
                        ...
                        >
                          <span
                            role="columnheader"
                            className="text-slate-500 text-lg font-bold box-border caret-transparent block leading-[33.75px] min-h-0 min-w-0 outline-[3px] w-full md:min-h-[auto] md:min-w-[50%] md:w-auto"
                          >
                            Category
                          </span>
                          <span
                            role="columnheader"
                            className="text-lg font-bold box-border caret-transparent block leading-[33.75px] min-h-0 min-w-0 outline-[3px] md:min-h-[auto] md:min-w-[auto]"
                          >
                            Details
                          </span>
                        </li>
                        <li
                          role="row"
                          className="relative text-sm box-border caret-transparent flex flex-wrap tracking-[-0.24px] leading-[19.992px] outline-[3px] px-3 py-2"
                        >
                          <span
                            role="cell"
                            className="text-slate-500 box-border caret-transparent block min-h-0 min-w-0 outline-[3px] w-full md:min-h-[auto] md:min-w-[50%] md:w-auto"
                          >
                            Capacity
                          </span>
                          <span
                            role="cell"
                            className="box-border caret-transparent block min-h-0 min-w-0 outline-[3px] md:min-h-[auto] md:min-w-[auto]"
                          >
                            113 L
                          </span>
                        </li>
                  ...
                  <div className="text-sm box-border caret-transparent h-0 leading-[25.375px] outline-[3px] invisible overflow-hidden md:text-[15.6667px] md:leading-[28.3958px]">
                    <div className="text-sm box-border caret-transparent leading-[25.375px] outline-[3px] pb-6 md:text-[15.6667px] md:leading-[28.3958px]">
                      <section className="text-sm box-border caret-transparent leading-[25.375px] outline-[3px] py-4 md:text-[15.6667px] md:leading-[28.3958px]">
                        <div className="text-sm box-border caret-transparent flex justify-start leading-[25.375px] outline-[3px] mb-4 md:text-[15.6667px] md:leading-[28.3958px]">
                          <div className="text-sm items-center box-border caret-transparent flex h-40 justify-center leading-[25.375px] min-h-0 min-w-0 outline-[3px] w-40 border border-neutral-500/30 mr-6 p-4 rounded-2xl border-solid md:text-[15.6667px] md:leading-[28.3958px] md:min-h-[auto] md:min-w-[auto]">
                            <figure className="relative text-sm box-border caret-transparent leading-[25.375px] min-h-0 min-w-0 outline-[3px] md:text-[15.6667px] md:leading-[28.3958px] md:min-h-[auto] md:min-w-[auto]">
                              <img
                          ...
                          <div className="text-sm box-border caret-transparent leading-[25.375px] min-h-0 min-w-0 outline-[3px] md:text-[15.6667px] md:leading-[28.3958px] md:min-h-[auto] md:min-w-[auto]">
                            ...
                            <dl className="text-sm box-border caret-transparent leading-[25.375px] outline-[3px] md:text-[15.6667px] md:leading-[28.3958px]">
                              <div className="text-sm items-center box-border caret-transparent flex leading-[25.375px] outline-[3px] mb-1 md:text-[15.6667px] md:leading-[28.3958px]">
                                <dt className="text-sm box-border caret-transparent tracking-[-0.24px] leading-[19.992px] min-h-0 min-w-0 outline-[3px] pr-2 md:min-h-[auto] md:min-w-[auto]">
                                  Height
                                </dt>
                                <dd className="text-sm box-border caret-transparent tracking-[-0.24px] leading-[19.992px] min-h-0 min-w-0 outline-[3px] md:min-h-[auto] md:min-w-[auto]">
                                  62.3 cm
                                </dd>
                              </div>
                              <div className="text-sm items-center box-border caret-transparent flex leading-[25.375px] outline-[3px] mb-1 md:text-[15.6667px] md:leading-[28.3958px]">
